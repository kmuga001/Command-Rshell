#ifndef DOUBLEOUTCONNECTOR_H
#define DOUBLEOUTCONNECTOR_H

#include "Command.h"
#include <string>

class DoubleOutConnector : public Command { /*Connector class does not need to exist*/
    public:
        DoubleOutConnector(string input) : Command(input) {}
